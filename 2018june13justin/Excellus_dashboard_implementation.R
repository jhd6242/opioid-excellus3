...
final_claim <- read_csv("opioid_total_claims_m22.csv")
...
final_claim<- final_claim[,c("Year", "County", "Payer",
                             "Opioid Emergency Room Counts", "Emergency Room Counts",
                             "Opioid Inpatient Counts", "Inpatient Counts",
                             "Opioid Outpatient Counts", "Outpatient Counts",
                             "Opioid Professional Counts", "Professional Counts",
                             "Opioid Other Counts", "Other Counts")]
...
colnames(final_claim)<- c('Year',"County","Payer",
                          ...
                          "Opioid.Professional.visits", "Total.Professional.visits",
                          "Opioid.Other.visits", "Total.Other.visits")
...
#Calculate the Opioid  Professional visit rate
final_claim$Professional.visit.rate<- round((final_claim$Opioid.Professional.visits/ final_claim$Total.Professional.visits )*1000,3)

#Calculate the Opioid  Other visit rate
final_claim$Other.visit.rate<- round((final_claim$Opioid.Other.visits/ final_claim$Total.Other.visits )*1000,3)
...
final_claim$Opioid.Overall.visits<- final_claim$Opioid.ER.visits+final_claim$Opioid.Inpatient.visits+final_claim$Opioid.Outpatient.visits+final_claim$Opioid.Professional.visits+final_claim$Opioid.Other.visits

#Calculate the total  visits that includes the summation of ER visits + Inpatient visits + Outpatient visits
final_claim$Total.Overall.visits<- final_claim$Total.ER.visits+final_claim$Total.Inpatient.visits + final_claim$Total.Outpatient.visits + final_claim$Total.Professional.visits + final_claim$Total.Other.visits
...
final_claim<- final_claim[,c('Year',"County","Payer",
                          "Opioid.ER.visits","Total.ER.visits","ER.visit.rate",
                          "Opioid.Inpatient.visits", "Total.Inpatient.visits", "Inpatient.visit.rate",
                          "Opioid.Outpatient.visits", "Total.Outpatient.visits", "Outpatient.visit.rate",
                          "Opioid.Professional.visits", "Total.Professional.visits", "Professional.visit.rate",
                          "Opioid.Other.visits", "Total.Other.visits", "Other.visit.rate",
                          "Opioid.Overall.visits", "Total.Overall.visits", "Overall.visit.rate")]
...
#Add the others and Professional intothe mix of IN, OUT and ER

final_claim$Indexed.Professional.rate<- round((final_claim$Professional.visit.rate/mean(final_claim$Professional.visit.rate))*100,3)

final_claim$Indexed.Other.rate<- round((final_claim$Other.visit.rate/mean(final_claim$Other.visit.rate))*100,3)
...
#Add the Professional Other into the ix of IN, OUT and ER
Excellus_all_region$Professional.visit.rate<- (Excellus_all_region$Opioid.Professional.visits/Excellus_all_region$Total.Professional.visits)*1000

Excellus_all_region$Other.visit.rate<- (Excellus_all_region$Opioid.Other.visits/Excellus_all_region$Total.Other.visits)*1000
...
Excellus_all_region<- Excellus_all_region[,c(1,2,5,8,11,14,17,20)]
#colnames(Excellus_all_region)<- c("Year",'Region','ER visit Rate','Inpatient visit Rate', 'Outpatient visit Rate','Overall visit Rate')

#NM March6, 2018
colnames(Excellus_all_region)<- c("Year",'Region',
                                  'ER Visit Rate','Inpatient Visit Rate', 'Outpatient Visit Rate',
                                  'Professional Visit Rate','Other Visit Rate', 'Overall Visit Rate')
...
Excellus_all_region<- melt(Excellus_all_region, id.vars=c("Region","Year"), measure.vars=colnames(Excellus_all_region)[3:8])
...
#FP March11, 2018
Excellus_all_payers$Professional.visit.rate<- (Excellus_all_payers$Opioid.Professional.visits/Excellus_all_payers$Total.Professional.visits)*1000

Excellus_all_payers$Other.visit.rate<- (Excellus_all_payers$Opioid.Other.visits/Excellus_all_payers$Total.Other.visits)*1000
...
#NM March 6, 2018
#This part is changed to meet the new others into the IN/OUT and ER
Excellus_all_payers<- Excellus_all_payers[,c(1,2,5,8,11,14,17, 20)]

#NM March6, 2018
colnames(Excellus_all_payers)<- c('Payer','Year', 'ER Visit Rate','Inpatient Visit Rate', 'Outpatient Visit Rate',
                                  'Professional Visit Rate','Other Visit Rate' ,'Overall Visit Rate')
...
#Convert all the facility visits columns into rows using melt function. This is used for structuring a dataframe so that it can be used for line-plots
Excellus_all_payers<- melt(Excellus_all_payers, id.vars=c("Payer", "Year"), measure.vars=colnames(Excellus_all_payers)[3:8])
...
Excellus$Professional.visit.rate<- (Excellus$Opioid.Professional.visits/Excellus$Total.Professional.visits)*1000

Excellus$Other.visit.rate<- (Excellus$Opioid.Other.visits/Excellus$Total.Other.visits)*1000
...
##Load the SAS logic
sas_logic <- read.csv("testtable.csv")
