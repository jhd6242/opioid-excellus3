...
load(file="/apps/rspro/projects/Opioid_Excellus/Excellus/dev-app/2018-august-9-justin/final.RData")
...
if(input$dependency_grouping=='PainandAbuse') {
  ...
  if(length(input$visit)==1)
    ...
    else if (input$dependency_grouping=='Diagnosis') {
...
# print(c("hi****************1 ", df))
    ...
    else if (input$dependency_grouping=='PainAbuseDiagnosis') {
...
if(input$dependency_grouping=='PainandAbuse'){
   ...
   output$map<- renderLeaflet({
    if (is.nan(map()@data[,20])) {
      stop(safeError("No PainandAbuse visits"))
    }
