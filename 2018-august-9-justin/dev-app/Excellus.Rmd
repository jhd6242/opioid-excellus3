  ...
  fluidRow(
    ...
    absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE, draggable = TRUE, top = 60, left = "auto", right = 20, bottom = "auto", width = 330, height= "auto",
                  ...
                  selectInput("payer", h4("Choose Line of Business:"), choices= payer, selected = "Commercial",multiple=TRUE, selectize = TRUE),
                   ...
                   selectInput("dependency_grouping", h4("Choose Opioid Grouping:"), choices= c('Pain and Abuse','Poisoning by Opiates'), selected = 'Pain and Abuse',multiple=TRUE, selectize = TRUE),
   ...
   conditionalPanel(
    ...
    absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE, draggable = TRUE, bottom = 0 , right = "auto", left = -5, top = "auto", width = 760, height= 10,
     ...
     conditionalPanel(
         condition = c("input.dependency_grouping == 'Pain and Abuse' && input.dependency_grouping == 'Poisoning by Opiates'"),
...
if(input$dependency_grouping=='Pain and Abuse') {
  ...
  if(length(input$visit)==1)
    ...
    else if (input$dependency_grouping=='Poisoning by Opiates') {
...
print(c("df",df))
    ...
    else if (input$dependency_grouping %in% "Pain and Abuse" & input$dependency_grouping %in% "Poisoning by Opiates") {
print("Dependence")
  if(length(input$visit)==1)
    { 
      #opioid_df$Year<- as.character(opioid_df$Year)
...
renderDataTable({
  ...
  Excellus$Payer<- as.factor(Excellus$Payer)
    ...
    print(c("Index1",Excellus$PainandAbuse.ER.visit.rate))
     Excellus$Diagnosis.Indexed.ER.rate<- as.integer((Excellus$Diagnosis.ER.visit.rate/mean(Excellus$Diagnosis.ER.visit.rate, na.rm=TRUE))*100)
      Excellus$PainAbuseDiagnosis.Indexed.ER.rate<- as.integer((Excellus$PainAbuseDiagnosis.ER.visit.rate/mean(Excellus$PainAbuseDiagnosis.ER.visit.rate, na.rm=TRUE))*100)
    ...
    Excellus$PainAbuseDiagnosis.Indexed.Inpatient.rate<- as.integer((Excellus$PainAbuseDiagnosis.Inpatient.visit.rate/mean(Excellus$PainAbuseDiagnosis.Inpatient.visit.rate, na.rm=TRUE))*100)
    ...
    Excellus$PainAbuseDiagnosis.Indexed.Outpatient.rate<- as.integer((Excellus$PainAbuseDiagnosis.Outpatient.visit.rate/mean(Excellus$PainAbuseDiagnosis.Outpatient.visit.rate, na.rm=TRUE))*100)
    ...
    Excellus$PainAbuseDiagnosis.Indexed.Professional.rate<- as.integer((Excellus$PainAbuseDiagnosis.Professional.visit.rate/mean(Excellus$PainAbuseDiagnosis.Professional.visit.rate, na.rm=TRUE))*100)
    ...
    Excellus$PainAbuseDiagnosis.Indexed.Other.rate<- as.integer((Excellus$PainAbuseDiagnosis.Other.visit.rate/mean(Excellus$PainAbuseDiagnosis.Other.visit.rate, na.rm=TRUE))*100)
    ...
    Excellus$PainAbuseDiagnosis.Indexed.Overall.rate<- as.integer((Excellus$PainAbuseDiagnosis.Overall.visit.rate/mean(Excellus$PainAbuseDiagnosis.Overall.visit.rate, na.rm=TRUE))*100)
  ...
  print(c("Apple",head(Excellus_display)))
    colnames(Excellus_display)<-c('Year','County', 'Line of Business',
                                  ...
                                  'Pain and Abuse Overall Visit', 'Poisoning by Opiates Overall Visit', 'Total Overall Visit', 'Pain and Abuse Overall Visit Rate', 'Poisoning by Opiates Overall Visit Rate','Pain and Abuse Indexed Overall Rate','Poisoning by Opiates Indexed Overall Rate')
