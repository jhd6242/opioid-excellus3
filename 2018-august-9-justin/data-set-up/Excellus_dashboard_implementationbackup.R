...
final_claim <- final_claim[, c(
  ...
  "Diagnosis.ER.visit.rate",
  "PainandAbuse.Inpatient.visits",
  "Diagnosis.Inpatient.visits",
  "Total.Inpatient.visits",
  "PainandAbuse.Inpatient.visit.rate",
  "Diagnosis.Inpatient.visit.rate",
  "PainandAbuse.Outpatient.visits",
  "Diagnosis.Outpatient.visits",
  "Total.Outpatient.visits",
  "PainandAbuse.Outpatient.visit.rate",
  "Diagnosis.Outpatient.visit.rate",
  "PainandAbuse.Professional.visits",
  "Diagnosis.Professional.visits",
  "Total.Professional.visits",
  "PainandAbuse.Professional.visit.rate",
  "Diagnosis.Professional.visit.rate",
  "PainandAbuse.Other.visits",
  "Diagnosis.Other.visits",
  "Total.Other.visits",
  "PainandAbuse.Other.visit.rate",
  "Diagnosis.Other.visit.rate",
  "PainandAbuse.Overall.visits",
  "Diagnosis.Overall.visits",
  "Total.Overall.visits",
  "PainandAbuse.Overall.visit.rate",
  "Diagnosis.Overall.visit.rate"
)]


#final_claim<- final_claim[,c(1:5,12, 6,7,13,8,9,15,10,11,14,16:18)]

#Calculate the indexed version for the PainandAbuse and Diagnosis for ER, Inpatient and Outpatient visits

#Indexed version of PainandAbuse and Diagnosis for ER
...
#Indexed version of PainandAbuse and Diagnosis for Inpatient
...
#Indexed version of PainandAbuse and Diagnosis for Outpatient
...
#Indexed version of PainandAbuse and Diagnosis for Professional
...
#Indexed version of PainandAbuse and Diagnosis for Other
...
#Indexed version of PainandAbuse and Diagnosis for Overall
...
#Calculate the ER, Inpatient, Outpatient and overall visit rate for PainandAbuse and Diagnosis
#ER visit rate for PainandAbuse and Diagnosis
...
#Inpatient visit rate for PainandAbuse and Diagnosis
...
#Outpatient visit rate for PainandAbuse and Diagnosis
...
#Add the Professional Other into the ix of IN, OUT and ERfor PainandAbuse and Diagnosis
#Professional visit rate for PainandAbuse and Diagnosis
...
#Other visit rate for PainandAbuse and Diagnosis
...
#Overall visit rate for PainandAbuse and Diagnosis
...
Excellus_all_region<- Excellus_all_region[,c(1,2,6,7,11,12,16,17,21,22,26,27,31,32)]
...
#NM March6, 2018
colnames(Excellus_all_region)<- c("Year",'Region','PainandAbuse ER visit Rate',' Diagnosis ER visit Rate',
                                  'PainandAbuse Inpatient visit Rate', 'Diagnosis Inpatient visit Rate',
                                  'PainandAbuse Outpatient visit Rate',' Diagnosis Outpatient visit Rate',
                                  'PainandAbuse Professional visit Rate', 'Diagnosis Professional visit Rate',
                                  'PainandAbuse Other visit Rate', 'Diagnosis Other visit Rate',
...
Excellus_all_region<- melt(Excellus_all_region, id.vars=c("Region","Year"), measure.vars=colnames(Excellus_all_region)[3:14])
...
#Calculating ER, Inpatient, Outpatient and overall visit rate for PainandAbuse and Diagnosis
#ER visit rate for PainandAbuse and Diagnosis
...
#NM March 6, 2018
#This part is changed to meet the new others into the IN/OUT and ER
Excellus_all_payers<- Excellus_all_payers[,c(1,2,6,7,11,12,16,17,21,22,26,27,31,32)]

#NM March6, 2018
colnames(Excellus_all_payers)<- c("Payer",'Year','PainandAbuse ER visit Rate',' Diagnosis ER visit Rate',
                                  'PainandAbuse Inpatient visit Rate', 'Diagnosis Inpatient visit Rate',
                                  'PainandAbuse Outpatient visit Rate',' Diagnosis Outpatient visit Rate',
                                  'PainandAbuse Professional visit Rate', 'Diagnosis Professional visit Rate',
                                  'PainandAbuse Other visit Rate', 'Diagnosis Other visit Rate',
...
#Convert all the facility visits columns into rows using melt function. This is used for structuring a dataframe so that it can be used for line-plots
Excellus_all_payers<- melt(Excellus_all_payers, id.vars=c("Payer", "Year"), measure.vars=colnames(Excellus_all_payers)[3:14])
...
Excellus$Excellus$Diagnosis.Outpatient.visit.rate<- (Excellus$Diagnosis.Outpatient.visits/Excellus$Total.Outpatient.visits)*1000 
#FP March11, 2018
#Outpatient visit rate for PainandAbuse and Diagnosis
